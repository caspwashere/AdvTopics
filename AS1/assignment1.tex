...
\usepackage{listings} % Environment for non-formatted code, !uses style file!de} % Environment for specifying algorithms in a natural way
...
\fancyfoot[L]{\textsc{Vulnerability Discovery and Exploitation}} % Custom footer text
...
\title{template_assignment} % Article title. Can leave unedited
\fancyhead[C]{}
\begin{minipage}{0.295\textwidth} % Left side of title section
\raggedright
RW716\\ % Your lecture or course
\footnotesize % Authors text size
%\hfill\\ % Uncomment if right minipage has more lines
Cindi-Ann Jeffery\\ % Your name and surname
Jayden Abrahams
\medskip\hrule
\end{minipage}
...
Code Review\\ % Assignment subtitle
\end{minipage}
